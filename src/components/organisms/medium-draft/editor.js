...
import {
    Block, Entity as E, HANDLED, NOT_HANDLED, KEY_COMMANDS,
} from './util/constants';
import beforeInput, { StringToTypeMap } from './util/beforeinput';
import blockStyleFn from './util/blockStyleFn';
import {
    getCurrentBlock, resetBlockWithType, addNewBlockAt, isCursorBetweenLink,
} from './model';
...
class MediumDraftEditor extends React.Component {
    static propTypes = {
        ...
        onHandleInputLink: PropTypes.func
    };
                ...
                <div className={editorClass}>
                    ...
                    {!disableToolbar && (
                        <Toolbar
                            ...
                            onHandleInputLink={onHandleInputLink}
                        />
                    )}
                    {isCursorLink && (
                        <LinkEditComponent
